...
function _gdriveMostrarConflicto(diff){
  const fmt = d => d ? d.toLocaleString(TIMEZONE_CONFIG.locale, {timeZone:TIMEZONE_CONFIG.timezone, day:'2-digit',month:'short',year:'numeric',hour:'2-digit',minute:'2-digit'}) : 'desconocida';
